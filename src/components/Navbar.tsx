...
const Navbar = () => {
  return (
    <div className='flex items-center justify-between p-4'>
        {/*search bar */}
        <div className="hidden md:flex items-center gap-2 text-xs rounded-full ring-[1.5px] ring-gray-300 gap-2 px-2">
        ...
        <div className="flex items-center gap-6 justify-end w-full">
          ...
          <div className="flex flex-col ">
             <span className="text-xs leading-3 font-medium">Manel</span>
